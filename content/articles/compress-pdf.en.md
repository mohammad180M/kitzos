---
title: "How to Compress a PDF Without Destroying Its Quality"
description: "Shrink oversized PDFs to pass email limits and upload caps — re-save structure or rasterize pages to JPEG, privately in your browser."
...
Understanding this explains the two strategies in the tool:

**Re-save & tidy structure** rewrites the PDF without changing page content. Text stays selectable; size may shrink slightly or occasionally grow. Use it when you must keep selectable text.

**Strong (rasterize)** draws each page as a JPEG at a chosen size/quality (optional grayscale). Scans and image-heavy PDFs often shrink a lot; text is no longer selectable. A quick estimate warns before processing if the result would grow.

## Compressing step by step

1. Open the Compress PDF tool and drop your file in.
2. Choose Re-save & tidy (keep text) or Strong (rasterize), and for Strong pick size/quality and optional grayscale.
...
**Will text stay sharp?** Re-save keeps real selectable text untouched. Strong turns pages into images, so “text” sharpness follows JPEG settings — prefer Re-save when selectable text must stay perfect.
